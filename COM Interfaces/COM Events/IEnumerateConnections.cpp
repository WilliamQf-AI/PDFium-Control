...
#include "PDFiumControl.h"
  ...
  PDFiumControl::_IEnumerateConnections::_IEnumerateConnections(
            IUnknown* pHostObj,
            ULONG cConnections,
  ...
  STDMETHODIMP PDFiumControl::_IEnumerateConnections::QueryInterface(REFIID riid,void **ppv) {
  *ppv = NULL;
  ...
  *ppv = (LPVOID)this;
  ...
  STDMETHODIMP_(ULONG) PDFiumControl::_IEnumerateConnections::AddRef() {
  ...
  STDMETHODIMP_(ULONG) PDFiumControl::_IEnumerateConnections::Release() {
  ...
  STDMETHODIMP PDFiumControl::_IEnumerateConnections::Next(ULONG cReq,CONNECTDATA* paConnections,ULONG* pcEnumerated) {
...
//    if ( NULL != paConnections -> pUnk ) paConnections -> pUnk -> AddRef();
  ...
  STDMETHODIMP PDFiumControl::_IEnumerateConnections::Skip(ULONG cSkip) {
  ...
  STDMETHODIMP PDFiumControl::_IEnumerateConnections::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }
  ...
  STDMETHODIMP PDFiumControl::_IEnumerateConnections::Clone(IEnumConnections** ppIEnum) {
